    ...
    <div>
      ...
      <div className="how">
        ...
        <h3>
          ...
          tennis is to hit the ball over the net and into the opponent's court,
          ...
          the opponent's service box. Tennis is played on various surfaces,
          including grass, clay, and hard courts, each of which affects the
          ball's speed and bounce differently. The gameplay involves a
          ...
          opponent's moves. Strategy plays a significant role in tennis. Players
          ...
          requires adaptability and the ability to adjust one's tactics based on
          the opponent's playing style and weaknesses. Tennis matches are
          ...
          recreational to professional. Whether you're a beginner or an
      ...
      <div className="famous">
        ...
        <h3>
          ...
          status as one of the sport's legends. 4. Steffi Graf: This German
          tennis player dominated women's tennis in the late 1980s and early
          ...
          groundstrokes and mental fortitude, Graf's achievements have etched
          her name in tennis history. 5. Novak Djokovic: Hailing from Serbia,
          Novak Djokovic has established himself as one of the most formidable
          players in tennis. With his exceptional flexibility, defensive skills,
          and mental toughness, he has captured 20 Grand Slam singles titles and
          has held the world number one ranking for extended periods. 6. Martina
